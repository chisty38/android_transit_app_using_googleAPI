...
public class MainActivity extends Activity {
    ...
    public void getInfo(View view) {
        ...
        try
        {
            ...
            //
            //
            destinationLatitude = URLEncoder.encode("43.6563", "UTF-8"); // Eaton Tower
            destinationLongitude = URLEncoder.encode("-79.3808", "UTF-8");
            ...
            Date date = new Date(2020, 11, 22, 16, 30, 0);
            ...
            //create the url
            strUrl = strUrl +origine+"&"+destination+"&"+sensor+"&"+departureTime+"&"+mode+"&key"+getResources().getString(R.string.key_API);
